/*
  ...
  - Added the required column `rele` to the `User` table without a default value. This is not possible if the table is not empty.
...
INSERT INTO "new_User" ("id", "name", "password", "rele", "updatedAt") 
SELECT "id", "name", 'temp_password', 'USER', CURRENT_TIMESTAMP FROM "User";
DROP TABLE "User";
