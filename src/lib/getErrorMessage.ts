...
const PRISMA_ERROR_CODES = new Map<string, string>([
  ["P2000", "The provided value for the column is too long for the type."],
  ["P2001", "The record search for in the where condition does not exist"],
  ...
  ["P2006", "The provided value for the filed is not valid."],
  ...
  [
    "P2017",
    "The records for relation between the partent and child model do not match.",
  ],
  ...
  ["P2027", "Mulyiple errors occurred on the database during query execution."],
]);
